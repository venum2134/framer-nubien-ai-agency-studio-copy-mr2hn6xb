// http-url:https://framerusercontent.com/modules/dEpDRdxpVR7S0smuhbSV/mzePkpddsFxMemR55cTn/QxYU5fGGT.js
import { jsx as _jsx2, jsxs as _jsxs } from "react/jsx-runtime";
import { addFonts, addPropertyControls as addPropertyControls2, ComponentViewportProvider, cx, getFonts, getPropertyControls, SmartComponentScopedContainer, useComponentViewport, useLocaleInfo, useVariantState, withCSS } from "framer";
...
var variantClassNames = { ZNblBMiVc: "framer-v-zw81sd" };
...
var getProps2 = ({ file, height, id, width, ...props }) => {
  return { ...props, XeTTYbda0: file ?? props.XeTTYbda0 ?? "https://framerusercontent.com/assets/8qsenQIIXYW3mI4IYIYBv9PMtkU.mp4" };
};
...
var Component = /* @__PURE__ */ React3.forwardRef(function(props, ref) {
  ...
  const { style, className, layoutId, variant, XeTTYbda0, ...restProps } = getProps2(props);
  const { baseVariant, classNames, clearLoadingGesture, gestureHandlers, gestureVariant, isLoading, setGestureState, setVariant, variants } = useVariantState({ defaultVariant: "ZNblBMiVc", variant, variantClassNames });
  ...
  return /* @__PURE__ */ _jsx2(LayoutGroup, { id: layoutId ?? defaultLayoutId, children: /* @__PURE__ */ _jsx2(Variants, { animate: variants, initial: false, children: /* @__PURE__ */ _jsx2(Transition, { value: transition1, children: /* @__PURE__ */ _jsx2(motion.div, { ...restProps, ...gestureHandlers, className: cx(scopingClassNames, "framer-zw81sd", className, classNames), "data-border": true, "data-framer-name": "Default", layoutDependency, layoutId: "ZNblBMiVc", ref: ref ?? ref1, style: { "--border-bottom-width": "1px", "--border-color": "var(--token-a9883d9b-c1bd-4bd9-be15-284cd72e1b1f, rgba(255, 255, 255, 0.07))", "--border-left-width": "1px", "--border-right-width": "1px", "--border-style": "solid", "--border-top-width": "1px", backdropFilter: "blur(2px)", backgroundColor: "var(--token-74f48371-76c0-476a-a319-1331b3a438c2, rgb(8, 8, 8))", borderBottomLeftRadius: 30, borderBottomRightRadius: 30, borderTopLeftRadius: 30, borderTopRightRadius: 30, WebkitBackdropFilter: "blur(2px)", ...style }, children: /* @__PURE__ */ _jsxs(motion.div, { className: "framer-1ljqxsk", "data-framer-name": "Content", layoutDependency, layoutId: "ZNblBMiVcjxfwA2AbE", style: { borderBottomLeftRadius: 22, borderBottomRightRadius: 22, borderTopLeftRadius: 22, borderTopRightRadius: 22 }, children: [/* @__PURE__ */ _jsx2(ComponentViewportProvider, { children: /* @__PURE__ */ _jsx2(SmartComponentScopedContainer, { className: "framer-l5rkck-container", isAuthoredByUser: true, isModuleExternal: true, layoutDependency, layoutId: "W0TcqKy_V-container", nodeId: "W0TcqKy_V", rendersWithMotion: true, scopeId: "QxYU5fGGT", children: /* @__PURE__ */ _jsx2(Video, { backgroundColor: "rgba(0, 0, 0, 0)", borderRadius: 0, bottomLeftRadius: 0, bottomRightRadius: 0, controls: false, height: "100%", id: "W0TcqKy_V", isMixedBorderRadius: false, layoutId: "W0TcqKy_V", loop: true, muted: true, objectFit: "cover", playing: true, posterEnabled: true, srcFile: XeTTYbda0, srcType: "Upload", srcUrl: "https://framerusercontent.com/assets/MLWPbW1dUQawJLhhun3dBwpgJak.mp4", startTime: 16.8, style: { height: "100%", width: "100%" }, topLeftRadius: 0, topRightRadius: 0, volume: 25, width: "100%" }) }) }), /* @__PURE__ */ _jsx2(motion.div, { background: { alt: "", fit: "fill" }, className: "framer-pa49co", "data-border": true, "data-framer-name": "Border", layoutDependency, layoutId: "fjbPE5StS", style: { "--border-bottom-width": "1px", "--border-color": "var(--token-082d630a-c036-4f77-8c8d-5d7b4650e064, rgba(255, 255, 255, 0.08))", "--border-left-width": "1px", "--border-right-width": "1px", "--border-style": "solid", "--border-top-width": "1px", borderBottomLeftRadius: 21, borderBottomRightRadius: 21, borderTopLeftRadius: 21, borderTopRightRadius: 21 } })] }) }) }) }) });
});
var css = ["@supports (aspect-ratio: 1) { body { --framer-aspect-ratio-supported: auto; } }", ".framer-JQhzw.framer-1g68r4h, .framer-JQhzw .framer-1g68r4h { display: block; }", ".framer-JQhzw.framer-zw81sd { align-content: center; align-items: center; display: flex; flex-direction: row; flex-wrap: nowrap; gap: 10px; height: 700px; justify-content: center; padding: 10px; position: relative; width: 1200px; }", ".framer-JQhzw .framer-1ljqxsk { align-content: center; align-items: center; display: flex; flex: 1 0 0px; flex-direction: row; flex-wrap: nowrap; gap: 10px; height: 100%; justify-content: center; overflow: hidden; padding: 1px; position: relative; width: 1px; will-change: var(--framer-will-change-override, transform); }", ".framer-JQhzw .framer-l5rkck-container { flex: none; height: 100%; left: calc(50.00000000000002% - 100% / 2); position: absolute; top: calc(50.00000000000002% - 100% / 2); width: 100%; }", ".framer-JQhzw .framer-pa49co { flex: none; height: 100%; left: calc(50.00000000000002% - 100% / 2); overflow: hidden; position: absolute; top: calc(50.00000000000002% - 100% / 2); width: 100%; will-change: var(--framer-will-change-override, transform); z-index: 1; }", "@supports (background: -webkit-named-image(i)) and (not (font-palette:dark)) { .framer-JQhzw.framer-zw81sd, .framer-JQhzw .framer-1ljqxsk { gap: 0px; } .framer-JQhzw.framer-zw81sd > *, .framer-JQhzw .framer-1ljqxsk > * { margin: 0px; margin-left: calc(10px / 2); margin-right: calc(10px / 2); } .framer-JQhzw.framer-zw81sd > :first-child, .framer-JQhzw .framer-1ljqxsk > :first-child { margin-left: 0px; } .framer-JQhzw.framer-zw81sd > :last-child, .framer-JQhzw .framer-1ljqxsk > :last-child { margin-right: 0px; } }", '.framer-JQhzw[data-border="true"]::after, .framer-JQhzw [data-border="true"]::after { content: ""; border-width: var(--border-top-width, 0) var(--border-right-width, 0) var(--border-bottom-width, 0) var(--border-left-width, 0); border-color: var(--border-color, none); border-style: var(--border-style, none); width: 100%; height: 100%; position: absolute; box-sizing: border-box; left: 0; top: 0; border-radius: inherit; pointer-events: none; }'];
var FramerQxYU5fGGT = withCSS(Component, css, "framer-JQhzw");
var QxYU5fGGT_default = FramerQxYU5fGGT;
FramerQxYU5fGGT.displayName = "Card/Video Card";
FramerQxYU5fGGT.defaultProps = { height: 700, width: 1200 };
addPropertyControls2(FramerQxYU5fGGT, { XeTTYbda0: VideoControls?.["srcFile"] && { ...VideoControls["srcFile"], __defaultAssetReference: "data:framer/asset-reference,8qsenQIIXYW3mI4IYIYBv9PMtkU.mp4?originalFilename=Framer%C3%AF%C2%BC%C2%9A+All+Design%2C+No+Code%2C+Real+Websites.mp4", description: void 0, hidden: void 0, title: "File" } });
addFonts(FramerQxYU5fGGT, [{ explicitInter: true, fonts: [] }, ...VideoFonts], { supportsExplicitInterCodegen: true });
export {
  QxYU5fGGT_default as default
};
