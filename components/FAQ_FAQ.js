// http-url:https://framerusercontent.com/modules/8X2QLrcoLsZNVaa81LbX/xgHdop8IXLbcn0f9r0lA/tAU8hAZZK.js
import { jsx as _jsx4, jsxs as _jsxs2 } from "react/jsx-runtime";
import { addFonts as addFonts2, ComponentViewportProvider as ComponentViewportProvider2, cx as cx2, getFonts as getFonts2, useComponentViewport as useComponentViewport2, useLocaleInfo as useLocaleInfo2, useVariantState as useVariantState2, withCSS as withCSS2 } from "framer";
...
// http-url:https://framerusercontent.com/modules/8X2QLrcoLsZNVaa81LbX/xgHdop8IXLbcn0f9r0lA/tAU8hAZZK.js
var FAQFAQSingleFonts = getFonts2(KTDz_N4A9_default);
var serializationHash2 = "framer-dIkND";
var variantClassNames2 = { MfFO9aD89: "framer-v-npqjcp" };
...
var Component3 = /* @__PURE__ */ React4.forwardRef(function(props, ref) {
  ...
  const { baseVariant, classNames, clearLoadingGesture, gestureHandlers, gestureVariant, isLoading, setGestureState, setVariant, variants } = useVariantState2({ defaultVariant: "MfFO9aD89", variant, variantClassNames: variantClassNames2 });
  const layoutDependency = createLayoutDependency2(props, variants);
  const ref1 = React4.useRef(null);
  const defaultLayoutId = React4.useId();
  const sharedStyleClassNames = [];
  const componentViewport = useComponentViewport2();
  return /* @__PURE__ */ _jsx4(LayoutGroup2, { id: layoutId ?? defaultLayoutId, children: /* @__PURE__ */ _jsx4(Variants2, { animate: variants, initial: false, children: /* @__PURE__ */ _jsx4(Transition2, { value: transition12, children: /* @__PURE__ */ _jsxs2(motion3.div, { ...restProps, ...gestureHandlers, className: cx2(serializationHash2, ...sharedStyleClassNames, "framer-npqjcp", className3, classNames), "data-framer-name": "Default", layoutDependency, layoutId: "MfFO9aD89", ref: ref ?? ref1, style: { ...style }, children: [/* @__PURE__ */ _jsx4(ComponentViewportProvider2, { height: 87, width: componentViewport?.width || "100vw", y: (componentViewport?.y || 0) + 0 + (((componentViewport?.height || 642) - 0 - 642) / 2 + 0 + 0), children: /* @__PURE__ */ _jsx4(motion3.div, { className: "framer-27jwqs-container", layoutDependency, layoutId: "andqdydr4-container", children: /* @__PURE__ */ _jsx4(KTDz_N4A9_default, { height: "100%", id: "andqdydr4", JYD7MrQlL: "What do I need to get started?", layoutId: "andqdydr4", p5Wkaih6b: "To get started, simply share your project details and goals with us. We'll guide you through the process and provide the tools and support needed to bring your vision to life.", style: { width: "100%" }, variant: "WKjSY8Jw3", width: "100%" }) }) }), /* @__PURE__ */ _jsx4(ComponentViewportProvider2, { height: 87, width: componentViewport?.width || "100vw", y: (componentViewport?.y || 0) + 0 + (((componentViewport?.height || 642) - 0 - 642) / 2 + 87 + 24), children: /* @__PURE__ */ _jsx4(motion3.div, { className: "framer-k92qtq-container", layoutDependency, layoutId: "To2sXZCjY-container", children: /* @__PURE__ */ _jsx4(KTDz_N4A9_default, { height: "100%", id: "To2sXZCjY", JYD7MrQlL: "What kind of customization is available?", layoutId: "To2sXZCjY", p5Wkaih6b: "We offer full customization options, including layout changes, color schemes, typography, and content sections to align with your brand. ", style: { width: "100%" }, variant: "WKjSY8Jw3", width: "100%" }) }) }), /* @__PURE__ */ _jsx4(ComponentViewportProvider2, { height: 87, width: componentViewport?.width || "100vw", y: (componentViewport?.y || 0) + 0 + (((componentViewport?.height || 642) - 0 - 642) / 2 + 174 + 48), children: /* @__PURE__ */ _jsx4(motion3.div, { className: "framer-1oyvg8c-container", layoutDependency, layoutId: "fwhdoGLK9-container", children: /* @__PURE__ */ _jsx4(KTDz_N4A9_default, { height: "100%", id: "fwhdoGLK9", JYD7MrQlL: "How easy is it to edit for beginners?", layoutId: "fwhdoGLK9", p5Wkaih6b: "Our platform is designed with beginners in mind, offering an intuitive drag-and-drop interface that makes editing simple and straightforward. No coding skills required\u2014just customize and go!", style: { width: "100%" }, variant: "WKjSY8Jw3", width: "100%" }) }) }), /* @__PURE__ */ _jsx4(ComponentViewportProvider2, { height: 87, width: componentViewport?.width || "100vw", y: (componentViewport?.y || 0) + 0 + (((componentViewport?.height || 642) - 0 - 642) / 2 + 261 + 72), children: /* @__PURE__ */ _jsx4(motion3.div, { className: "framer-1phz1hp-container", layoutDependency, layoutId: "WQLzKPZ1a-container", children: /* @__PURE__ */ _jsx4(KTDz_N4A9_default, { height: "100%", id: "WQLzKPZ1a", JYD7MrQlL: "Let me know more about moneyback guarantee?", layoutId: "WQLzKPZ1a", p5Wkaih6b: "Our money-back guarantee ensures peace of mind by offering a full refund if you\u2019re not satisfied with the final product within a specified time frame.", style: { width: "100%" }, variant: "WKjSY8Jw3", width: "100%" }) }) }), /* @__PURE__ */ _jsx4(ComponentViewportProvider2, { height: 87, width: componentViewport?.width || "100vw", y: (componentViewport?.y || 0) + 0 + (((componentViewport?.height || 642) - 0 - 642) / 2 + 348 + 96), children: /* @__PURE__ */ _jsx4(motion3.div, { className: "framer-6hh9h6-container", layoutDependency, layoutId: "KjV3VVBc3-container", children: /* @__PURE__ */ _jsx4(KTDz_N4A9_default, { height: "100%", id: "KjV3VVBc3", JYD7MrQlL: "Do I need to know how to code?", layoutId: "KjV3VVBc3", p5Wkaih6b: "No, you don\u2019t need to know how to code. Our platform offers intuitive tools and templates that allow you to create and manage your website with ease.", style: { width: "100%" }, variant: "WKjSY8Jw3", width: "100%" }) }) }), /* @__PURE__ */ _jsx4(ComponentViewportProvider2, { height: 87, width: componentViewport?.width || "100vw", y: (componentViewport?.y || 0) + 0 + (((componentViewport?.height || 642) - 0 - 642) / 2 + 435 + 120), children: /* @__PURE__ */ _jsx4(motion3.div, { className: "framer-51lr3d-container", layoutDependency, layoutId: "VSwCSXUNg-container", children: /* @__PURE__ */ _jsx4(KTDz_N4A9_default, { height: "100%", id: "VSwCSXUNg", JYD7MrQlL: "What will I get after purchasing the template?", layoutId: "VSwCSXUNg", p5Wkaih6b: "After purchasing the template, you'll receive a fully customizable, ready-to-use design with all necessary files and documentation.", style: { width: "100%" }, variant: "WKjSY8Jw3", width: "100%" }) }) })] }) }) }) });
});
var css4 = ["@supports (aspect-ratio: 1) { body { --framer-aspect-ratio-supported: auto; } }", ".framer-dIkND.framer-j0uqxq, .framer-dIkND .framer-j0uqxq { display: block; }", ".framer-dIkND.framer-npqjcp { align-content: center; align-items: center; display: flex; flex-direction: column; flex-wrap: nowrap; gap: 24px; height: min-content; justify-content: center; overflow: visible; padding: 0px; position: relative; width: 692px; }", ".framer-dIkND .framer-27jwqs-container, .framer-dIkND .framer-k92qtq-container, .framer-dIkND .framer-1oyvg8c-container, .framer-dIkND .framer-1phz1hp-container, .framer-dIkND .framer-6hh9h6-container, .framer-dIkND .framer-51lr3d-container { flex: none; height: auto; position: relative; width: 100%; }", "@supports (background: -webkit-named-image(i)) and (not (font-palette:dark)) { .framer-dIkND.framer-npqjcp { gap: 0px; } .framer-dIkND.framer-npqjcp > * { margin: 0px; margin-bottom: calc(24px / 2); margin-top: calc(24px / 2); } .framer-dIkND.framer-npqjcp > :first-child { margin-top: 0px; } .framer-dIkND.framer-npqjcp > :last-child { margin-bottom: 0px; } }"];
var FramertAU8hAZZK = withCSS2(Component3, css4, "framer-dIkND");
var tAU8hAZZK_default = FramertAU8hAZZK;
FramertAU8hAZZK.displayName = "FAQ/FAQ";
FramertAU8hAZZK.defaultProps = { height: 642, width: 692 };
addFonts2(FramertAU8hAZZK, [{ explicitInter: true, fonts: [] }, ...FAQFAQSingleFonts], { supportsExplicitInterCodegen: true });
export {
  tAU8hAZZK_default as default
};
